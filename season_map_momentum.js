// season_map_momentum.js (korrigierte Version)
// - robust gegen unterschiedliche IDs: 'seasonTimeTrackingBox' oder 'seasonMapTimeTrackingBox'
// - loggt Status in der Konsole
...
(function () {
  ...
  // try several known IDs (backwards compatibility)
  function getTimeBoxElement() {
    ...
    console.debug('[momentum] No known time box id found. Candidates:', ['seasonTimeTrackingBox','seasonMapTimeTrackingBox','timeTrackingBox']);
    return null;
  }
  ...
  function readTimeBoxData() {
    ...
    // If no period elements, try to read simple layout where buttons may be directly inside box
    if (periods.length === 0) {
  ...
  function renderSeasonMomentumGraphic() {
    ...
    axisLabel.setAttribute('x', (SVG_W/2).toFixed(0)); axisLabel.setAttribute('y', (SVG_H - 6).toFixed(0)); axisLabel.setAttribute('text-anchor','middle');
    axisLabel.setAttribute('font-family','Segoe UI, Roboto'); axisLabel.setAttribute('font-weight','700'); axisLabel.setAttribute('font-size','16');
    axisLabel.setAttribute('fill','#111'); axisLabel.textContent = 'Gameplay';
    svg.appendChild(axisLabel);
    const leftLabel = document.createElementNS(svgNS,'text');
    leftLabel.setAttribute('x','6'); leftLabel.setAttribute('y',(MIDLINE_Y+4).toFixed(0)); leftLabel.setAttribute('text-anchor','start');
    leftLabel.setAttribute('font-family','Segoe UI, Roboto'); leftLabel.setAttribute('font-weight','700'); leftLabel.setAttribute('font-size','14');
    leftLabel.setAttribute('fill','#111'); leftLabel.textContent = 'Momentum';
